...
class UnknownError extends AppException {
  UnknownError([String? message]) : super("Error Occur: ", message);
}

class JsonSerializationError extends AppException {
  JsonSerializationError([String? message])
      : super("Cannot Serialize: ", message);
}
